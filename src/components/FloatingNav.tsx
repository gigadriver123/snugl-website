    ...
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
      <nav className="flex items-center gap-1 p-1.5 bg-white/80 backdrop-blur-lg border border-white/20 rounded-full shadow-lg shadow-black/5 ring-1 ring-black/5">
        <button
          ...
          className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeSection === "home"
        ...
        <button
          ...
          className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeSection === "features"
              ? "text-white bg-gray-900 shadow-md"
              : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
            }`}
        >
        ...
        <button
          ...
          className={`relative px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${activeSection === "faq"
              ? "text-white bg-gray-900 shadow-md"
              : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
            }`}
        >
