...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "You can reach us at snugled.com/support. We're here to help with any questions or issues you might have."
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Minimal Footer */}
        <footer className="py-12 px-4 bg-white/30 backdrop-blur-sm">
